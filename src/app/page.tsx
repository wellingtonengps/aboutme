...
export default function Home() {
    return (
        <main
            ...
            <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="flex flex-col items-center md:items-start md:ml-16  mt-8 md:mt-0">
                    ...
                    <div className="flex flex-row gap-3 items-center">
                        <Image src="/school_icon.svg" alt="school icon" height={18} width={18}/>
                        <h2 className="text-xs">Ciência da Computação - UFJF</h2>
                    </div>
                    <div className="flex flex-row gap-3 items-center">
                        <Image src="/work_icon.svg" alt="school icon" height={18} width={18}/>
                        <h2 className="text-xs">Estagiário de Suporte</h2>
                    </div>

                    <div className="flex flex-row gap-3 items-center">
                        <Image src="/apartment_icon.svg" alt="school icon" height={18} width={18}/>
                        <h2 className="text-xs">Hospital Unimed Dr. Hugo Borges</h2>
                    </div>

                    <p className="text-sm mt-3 text-justify md:text-start">Olá, sou Wellington estudante de Ciência da
                        Computação,
            ...
            <div className="flex flex-col mt-8 items-center ">
                <h1 className="mb-4 text-center text-2xl">Habilidades Técnicas</h1>
